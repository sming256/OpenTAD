_base_ = [
    "../../_base_/datasets/epic_kitchens-100/e2e_noun_train_trunc_test_sw_s16_768x1_224.py",  # dataset config
...
work_dir = "exps/epic_kitchens/adatad/e2e_actionformer_videomae_l_ft_768x8_160_noun_adapter"
