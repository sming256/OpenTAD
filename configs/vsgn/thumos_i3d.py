...
window_size = 320
dataset = dict(
    train=dict(window_overlap_ratio=0.75, window_size=window_size),
    val=dict(window_overlap_ratio=0.75, window_size=window_size),
    test=dict(window_overlap_ratio=0.75, window_size=window_size),
)
...
scheduler = dict(type="MultiStepLR", milestones=[20], max_epoch=20)
