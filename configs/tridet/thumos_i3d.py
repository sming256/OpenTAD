...
model = dict(projection=dict(in_channels=2048, input_noise=0.0005))
...
scheduler = dict(type="LinearWarmupCosineAnnealingLR", warmup_epoch=20, max_epoch=40, eta_min=1e-8)
