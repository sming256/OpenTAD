...
model = dict(
    ...
    roi_head=dict(
        proposal_generator=dict(dscale=64, sampling_ratio=0.1),
        proposal_roi_extractor=dict(roi_size=16),
        proposal_head=dict(roi_size=16, feat_channels=256),
    ),
)
...
work_dir = "exps/thumos/etad_i3d_sw128"
